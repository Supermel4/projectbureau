		...
		<div class="py-4">
			<div class="py-4 overflow-x-auto flex flex-wrap">
                        ...
                        foreach ($activiteiten_result as $item)
						{
							...
							<h1 class="text-2xl text-center font-bold">'.htmlspecialchars(ucfirst($item['activiteitnaam'])).'</h1>
							<br>
							<h1 class="text-center">Op <b>'.htmlspecialchars($newStartDate).'</b> tot <b>'.htmlspecialchars($newEndDate).'</b></h1>
