		...
		<div class="py-4">
			<div class="py-4 overflow-x-auto flex flex-wrap">
                        ...
                        foreach ($activiteiten_result as $item)
						{
                            ...
                            <br>
                            <a href=""><button class="bg-green-400 hover:bg-green-600 text-white font-bold py-2 px-4 rounded-2xl transition-colors duration-500"><i class="fas fa-plus"></i> Aanmelden</button></a>
                            <a href=""><button class="bg-red-400 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-2xl transition-colors duration-500"><i class="fas fa-minus"></i> Afmelden</button></a>
                            </div>
							</div>
							';
					} ?>
